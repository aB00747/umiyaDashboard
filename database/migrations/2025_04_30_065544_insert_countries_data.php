...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($countryCount == 0) {
            ...
            // Add timestamps to all country entries
            $timestamp = now();
    ...
    {
        // We don't want to remove the data when rolling back,
        // as it might break foreign key constraints.
        // But if you want to clear the data, you can uncomment the line below:
