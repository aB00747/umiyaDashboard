    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          {settings.map((s) => (
            <div key={s.key} className="flex items-end gap-4 p-4 bg-gray-50 rounded-lg">
              <div className="flex-1">
                <label className="block text-xs font-medium text-gray-500 mb-1">{s.key}</label>
                <input
                  type="text"
          ...
          {settings.length === 0 && (
            <p className="text-sm text-gray-500 text-center py-4">No settings configured</p>
          )}
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div className="flex justify-between p-3 bg-gray-50 rounded-lg">
            ...
            <span className="font-medium text-gray-900">Django REST Framework</span>
          </div>
          <div className="flex justify-between p-3 bg-gray-50 rounded-lg">
          ...
          <div className="flex justify-between p-3 bg-gray-50 rounded-lg">
            ...
            <span className="font-medium text-gray-900">JWT (SimpleJWT)</span>
          </div>
        </div>
      </div>
    </div>
